...
import 'package:parse_deneme/view/livelist.dart';
import 'package:parse_deneme/view/livelist2.dart';
import 'package:parse_deneme/view/messageScreen.dart';
import 'package:parse_deneme/view/messageScreen2.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> filterItem(counter) async {
    QueryBuilder<ParseObject> queryCars =
        QueryBuilder<ParseObject>(ParseObject('siparisler'))
          ..whereEqualTo('objectId', 'TpyOkLTdAF');
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            RaisedButton(onPressed: () async {
              //veri ekleme
              var apiResponse = await ParseObject('siparisler').getAll();

              if (apiResponse.success) {
                for (var testObject in apiResponse.result) {
                  print('siparisler' + ": " + testObject.toString());
                }
              }
            }),
            RaisedButton(onPressed: () async {
